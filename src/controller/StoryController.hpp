...
public:
    static std::shared_ptr<StoryController> createShared(OATPP_COMPONENT(std::shared_ptr<ObjectMapper>, objectMapper) // Inject objectMapper component here as default parameter
    )
    {
    ...
    ENDPOINT("POST", "stories", createStory, BUNDLE(String, userId), BODY_DTO(Object<StoryDto>, storyDto))
    {
        storyDto->id = nullptr;
    ...
    ENDPOINT("PUT", "stories/{storyId}", putStory, BUNDLE(String, userId), PATH(String, storyId), BODY_DTO(Object<StoryDto>, storyDto))
    {
        storyDto->id = storyId;
    ...
    ENDPOINT("GET", "stories/{storyId}", getStoryById, BUNDLE(String, userId), PATH(String, storyId))
    {
    ...
    ENDPOINT("GET", "stories/offset/{offset}/limit/{limit}", getStories, BUNDLE(String, userId), PATH(UInt32, offset), PATH(UInt32, limit))
    {
    ...
    ENDPOINT("DELETE", "stories/{userId}", deleteStory, BUNDLE(String, userId), PATH(String, storyId))
    {
