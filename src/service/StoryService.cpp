...
oatpp::Object<StoryDto> StoryService::getStoryByUserIdAndId(const oatpp::String& userId, const oatpp::String& id, const oatpp::provider::ResourceHandle<oatpp::orm::Connection>& connection)
{
...
oatpp::Object<PageDto<oatpp::Object<StoryDto>>> StoryService::getAllUserStories(const oatpp::String& userId, const oatpp::UInt32& offset, const oatpp::UInt32& limit)
{
